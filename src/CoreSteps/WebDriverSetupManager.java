...
public class WebDriverSetupManager{
	 ...
	 * @param validate - set true if link needs to be validated
	 * @throws Exception
	 */
	public static void startBrowser(String url, boolean validate) throws Exception {
